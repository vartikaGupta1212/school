...
export const getASNTS = token => {
  return dispatch => {
    ...
    axios
      .get("https://school-optimise.herokuapp.com/assignments/")
      .then(res => {
        console.log(res)
...
export const getASNTSDetail = (token, id) => {
  return dispatch => {
    ...
    axios
      .get(`https://school-optimise.herokuapp.com/assignments/${id}/`)
      .then(res => {
...
export const createASNT = (token, asnt) => {
  return dispatch => {
    ...
    axios
      .post(`https://school-optimise.herokuapp.com/assignments/`, asnt)
      .then(res => {
